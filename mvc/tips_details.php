<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo $tips_title; ?></li>
  </ol>
</nav>
...
<?php
//views update
mysqli_query($con,"UPDATE car_tips SET views=views+1 WHERE tips_id=$tips_id");
...
&nbsp;&nbsp; Views: <?php echo $rt["views"]; ?>
<span style="float: right;"><a href="<?php echo $site_url; ?>/tips-bn/<?php echo $rt['tips_slug']; ?>/" title="Bangla Version"><button type="button" class="btn btn-success btn-sm">Bangla Version</button></a></span>

<h1 align="center"><font size="5"><?php echo $rt["tips_title"]; ?></font></h1>
...
if($photo!=""){
  ...
  echo "<img src='$site_url/images/tips/noimage.jpg' class='img-responsive' style='width:50%; height:50%;'>";
}
...
<?php echo nl2br($rt["tips_details"]); ?>
</div>
