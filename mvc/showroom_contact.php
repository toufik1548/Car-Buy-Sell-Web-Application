...
<b>Showroom Mobile Number Request</b>
...
<div class="alert alert-success" role="alert">
  <b>শোরুম এর ফোন নম্বরটি আপনার মোবাইলএসএমএস এ প্রেরন করা হবে</b>
</div>
...
$showroom_id = trim(addslashes($_POST["showroom_id"]));
...
//SMS Sent Start
    ...
    $sender_id = $sms_sender_number; //"8809610991236";//"8809601001019";//"8809610991236";

    $text = "$showroom_name mobile number $seller_mobile \n \n www.deshicar.com";
    $text2 = "Mr. $buyer_name ($buyer_mobile) received your showroom mobile  \n \n www.deshicar.com";
...
<form method="post" action=" " name="myForm" onsubmit="return validateForm()" >
    ...
    <input type="hidden" name="showroom_id" value=" <?php echo $showroom_id ?> ">
