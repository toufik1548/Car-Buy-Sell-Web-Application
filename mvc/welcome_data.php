...
if (isset($_POST['getData'])) {
   ...
   // $user_type_id = get_info("car_users","type_id","WHERE user_id=$user_id");
    ...
    if(!is_file("../images/products/".$car_photo)){$car_photo="deshicar_nophoto.jpg";}
...
$response .= '
        ...
        <img class="thumbnail" style="width:100%;" src="'.$site_url.'/images/products/'.$car_photo.'">
        </a></div>
