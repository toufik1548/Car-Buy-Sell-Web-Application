...
<div id="title">Car photo upload</div>
<div id="area">
...
unlink("./images/products/".$_POST['photo_name']);
}
...
echo "<a class=\"btn btn-primary\" href=\"$site_url/car-photo-upload/$slug\" role=\"button\">Try Again</a>";
  ...
  <tr>
  	...
  	<?php
				...
				while($r2	=	mysqli_fetch_array($q2))
						...
						?>
					<td>
<img src="<?php echo $site_url; ?>/images/products/<?php echo $r2['photo_name']; ?>" width="80"><br>
