<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo $news_title_bn; ?></li>
  </ol>
</nav>
...
<?php
//views update
mysqli_query($con,"UPDATE car_news SET views_bn=views_bn+1 WHERE news_id=$news_id");
...
&nbsp;&nbsp; Views: <?php echo $rn["views_bn"]; ?>
<span style="float: right;"><a href="<?php echo $site_url; ?>/news-en/<?php echo $rn['news_slug']; ?>/" title="English Version"><button type="button" class="btn btn-success btn-sm">English Version</button></a></span>

<h1 align="center"><font SIZE="5"><?php echo $rn["news_title_bn"]; ?></font></h1>
...
<?php echo nl2br($rn["news_details_bn"]); ?>
</div>
