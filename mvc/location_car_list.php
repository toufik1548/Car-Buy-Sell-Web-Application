...
<?php
//$cond $sort $limit
$qnc = mysqli_query($con,"SELECT * FROM car_used WHERE status=1 AND location_id=$location_id");
...
<h2>
<a href="<?php echo $site_url; ?>/used-car/<?php echo $rnc['car_slug']; ?>/" class="p-title">
<?php echo $car_name; ?>
</a>
</h2>
...
<a href="<?php echo $site_url; ?>/used-car/<?php echo $rnc['car_slug']; ?>/"><button class="btn btn-success btn-block">Details</button></a>
