  ...
  <table class="table table-striped table-bordered" id="mytable">
    <tbody>
      <tr>
        ...
        <td>
          <input type="text" name="car_name" class="form-control" id="text" placeholder="Ex: Maruti Swift" value="<?php echo $Car_Name; ?>" style="width: 100%" maxlength="250" required>    
...
<?php if(isset($_POST['edition_id']) && $_POST['edition_id']==$rf['edition_id']){echo "Selected";}?>
  ...
  <?php } ?>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="car_yom" class="form-control" id="text" placeholder="0000" value="<?php echo $Car_Yom; ?>" style="width: 100%" maxlength="4">    
          <small id="small"></small>
        </td>
      </tr>
  ...
  <tr>
    <td colspan="2" align="center"><font size="5" color="red"><strong>Engine and Transmission</strong></font></td>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="engine_type" class="form-control" id="text" placeholder="Ex: DDiS 190 Engine" value="<?php echo $Engine_Type; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_cc" class="form-control" id="text" placeholder="Ex: 1248 cc" value="<?php echo $Engine_Cc; ?>" style="width: 100%" maxlength="8">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_max_power" class="form-control" id="text" placeholder="Ex: 74bhp@4000rpm" value="<?php echo $Engine_Max_Power; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_max_torque" class="form-control" id="text" placeholder="Ex: 190Nm@2000rpm" value="<?php echo $Engine_Max_Torque; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_cylinders" class="form-control" id="text" placeholder="Ex: 4" value="<?php echo $Engine_Cylinders; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_cylinder_valves" class="form-control" id="text" placeholder="Ex: 4" value="<?php echo $Engine_Cylinder_Valves; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_valve_configs" class="form-control" id="text" placeholder="Ex: V" value="<?php echo $Engine_Valve_Configs; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_fuel_supply_system" class="form-control" id="text" placeholder="Ex: CRDi" value="<?php echo $Engine_Fuel_Supply_System; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
...
<?php if(isset($_POST['trans_id']) && $_POST['trans_id']==$rt['trans_id']){echo "Selected";}?>
	...
	<?php } ?>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="engine_gearbox" class="form-control" id="text" placeholder="Ex: 5" value="<?php echo $Engine_Gearbox; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_drive" class="form-control" id="text" placeholder="Ex: FWD" value="<?php echo $Engine_Drive; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_compression_ratio" class="form-control" id="text" placeholder="engine compression ratio" value="<?php echo $Engine_Compression_Ratio; ?>" style="width: 100%" maxlength="20">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="engine_bore_stroke" class="form-control" id="text" placeholder="engine bore stroke" value="<?php echo $Engine_Bore_Stroke; ?>" style="width: 100%" maxlength="20">    
          <small id="small"></small>
        </td>
      </tr>
...
<?php if(isset($_POST['fuel_id']) && $_POST['fuel_id']==$rf['fuel_id']){echo "Selected";}?>
	...
	<?php } ?>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="fuel_tank_capacity" class="form-control" id="text" placeholder="Ex: 37" value="<?php echo $Fuel_Tank_Capacity; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="fuel_mileage_city" class="form-control" id="text" placeholder="Ex: 27.38" value="<?php echo $Fuel_Mileage_City; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="fuel_mileage_highway" class="form-control" id="text" placeholder="Ex: 170" value="<?php echo $Fuel_Mileage_Highway; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
  ...
  <tr>
    <td colspan="2" align="center"><font size="5" color="red"><strong>Performance</strong></font></td>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="performance_topspeed" class="form-control" id="text" placeholder="Ex: 170" value="<?php echo $Performance_Topspeed; ?>" style="width: 100%" maxlength="20">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="performance_acceleration_60" class="form-control" id="text" placeholder="Ex: 8.54 Seconds" value="<?php echo $Performance_Acceleration_60; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="performance_acceleration_100" class="form-control" id="text" placeholder="Ex: 12.38 Seconds" value="<?php echo $Performance_Acceleration_100; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
  ...
  <tr>
    <td colspan="2" align="center"><font size="5" color="red"><strong>Suspensions</strong></font></td>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="suspension_front" class="form-control" id="text" placeholder="Ex: Macpherson Strut" value="<?php echo $Suspension_Front; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="suspension_rear" class="form-control" id="text" placeholder="Ex: Torsion Beam" value="<?php echo $Suspension_Rear; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
  ...
  <tr>
    <td colspan="2" align="center"><font size="5" color="red"><strong>Brakes</strong></font></td>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="breaks_front" class="form-control" id="text" placeholder="Ex: Disc" value="<?php echo $Breaks_Front; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="breaks_rear" class="form-control" id="text" placeholder="Ex: Drum" value="<?php echo $Breaks_Rear; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
...
<?php if(isset($_POST['type_id']) && $_POST['type_id']==$rbt['type_id']){echo "Selected";}?>
  ...
  <?php } ?>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="body_length" class="form-control" id="text" placeholder="Ex: 3840" value="<?php echo $Body_Length; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_width" class="form-control" id="text" placeholder="Ex: 1735" value="<?php echo $Body_Width; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_height" class="form-control" id="text" placeholder="Ex: 1530" value="<?php echo $Body_Height; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_colors" class="form-control" id="text" placeholder="Ex: Red" value="<?php echo $Body_Colors; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_doors" class="form-control" id="text" placeholder="Ex: 5" value="<?php echo $Body_Doors; ?>" style="width: 100%" maxlength="3">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_seats" class="form-control" id="text" placeholder="Ex: 5" value="<?php echo $Body_Seats; ?>" style="width: 100%" maxlength="3">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_boot_space" class="form-control" id="text" placeholder="Ex: 268" value="<?php echo $Body_Boot_Space; ?>" style="width: 100%" maxlength="100">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_ground_clearance" class="form-control" id="text" placeholder="Ex: 163" value="<?php echo $Body_Ground_Clearance; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <input type="text" name="body_wheelbase" class="form-control" id="text" placeholder="Ex: 2450" value="<?php echo $Body_Wheelbase; ?>" style="width: 100%" maxlength="10">    
          <small id="small"></small>
        </td>
      </tr>
  ...
  <tr>
    <td colspan="2" align="center"><font size="5" color="red"><strong>Others</strong></font></td>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="car_price" class="form-control" id="text" placeholder="00000000" value="<?php echo $Car_Price; ?>" style="width: 100%">    
